...
def add_service():
    ...
    return render_template('tailor/add_service.html', form=form)
...
def edit_service(service_id):
    ...
    return render_template('tailor/edit_service.html', form=form, tailor_service=tailor_service)
...
def order_details(order_id):
    ...
    form = SimpleSubmitForm()
    note = request.form.get('note')  # Still needed for note text
    ...
    return render_template('tailor/order_details.html', order=order, form=form)
